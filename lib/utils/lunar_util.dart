import 'package:custom_calendar/utils/solar_term_util.dart';
...
///*/
class LunarUtil {
  static List<int> lunarMonthDays = [
    1887,
    0x1694,
    0x16aa,
    0x4ad5,
  ...
  /// 保存每年24节气
  static final Map<int, List<String>> solarTerms = {};

  /// 公历节日
  static List<String> solarCalendar = [
    "0101元旦",
    "0214情人节",
    "0308妇女节",
    "0312植树节",
  ...
  /// 传统农历节日
  static List<String> traditionFestivalStr= [
    "除夕",
    "0101春节",
    "0115元宵",
    "0505端午",
  ...
  /// 特殊节日的数组
  static List<String> specialFestivalStr = [
    "母亲节",
    "父亲节",
    "感恩节",
  ];
...
//   }
  ...
  static String gregorianFestival(int month, int day) {
    ...
    String solar = "";
    for (String aMSolarCalendar in solarCalendar) {
  ...
  static String getTraditionFestival(int year, int month, int day) {
    ...
    String text = getString(month, day);
    String festivalStr = "";
    for (String festival in traditionFestivalStr) {
  ...
  static List<String> getSpecialFestivals(int year) {
    ...
    DateTime dateTime = DateTime(year, 5, 1);
