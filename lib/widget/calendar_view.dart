import 'package:custom_calendar/widget/week_view_pager.dart';
...
class _CalendarViewWidgetState extends State<CalendarViewWidget> {
  ...
  void initState() {
    ...
    widget.calendarController.calendarProvider.initData(
        ...
        selectDateModel: widget.calendarController.calendarConfiguration.selectDateModel,
...
class CalendarContainerState extends State<CalendarContainer>
  ...
  @override
  Widget build(BuildContext context) {
    LogUtil.log(TAG: runtimeType, message: "CalendarContainerState build");
    return Container(
      width: itemHeight * 7,
      child: Column(
